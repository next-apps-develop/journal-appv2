...
const RegisterComponent = () => {
  ...
  return (
    <div className="flex flex-col justify-center w-full px-8">
      ...
      <form action="" onSubmit={onSubmit} className="block w-full" autoComplete="off">
        <div className="input-container mb-4">
          ...
          {errors.fullName && (
            // @ts-ignore
            <span className="block text-red-400 text-sm">{errors.fullName?.message}</span>
          )}
        </div>
        ...
        <div className="input-container mb-4">
          ...
          {errors.email && (
            // @ts-ignore
            <span className="block text-red-400 text-sm">{errors.email?.message}</span>
          )}
        </div>
        ...
        <div className="input-container mb-4">
          ...
          {errors.password && (
            // @ts-ignore
            <span className="block text-red-400 text-sm">{errors.password?.message}</span>
          )}
        </div>
        ...
        <div className="input-container mb-8">
          ...
          <input
            ...
            className="block w-full px-4 py-2 text-white bg-zinc-800 tracking-wider text-[16px]"
        ...
        <ButtonGeneral text={'Register'} className="text-white" />
